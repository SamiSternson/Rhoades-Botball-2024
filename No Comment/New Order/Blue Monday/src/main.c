...
int main(){
    ...
    servo(0, 2000, 2047);
    servo(0, 2000, 700); // raise claw with astronaut
    servo(0, 2200, 2247);
    motor(0,87); // curve towards wall
    motor(2,85);
    msleep(300);
    while(analog(0)<2500) // drive along wall straightning out until reaching black line at edge of starting zone
    {
        motor(0,72);
        motor(2,70);
    }
